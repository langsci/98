...
\newcommand{\sensenr}[1]{ {\bfseries\large\itshape #1}}
...
\newcommand{\type}[1]{$\xrightarrow{\makebox[.4cm]{\tiny #1}}$}
...
\newcommand{\typeant}[1]{#1}
\newcommand{\typeasmlvar}[1]{#1}
\newcommand{\typecf}[1]{#1}
\newcommand{\typecntrof}[1]{#1}
\newcommand{\typecntrvarof}[1]{#1}
\newcommand{\typedialvarGu}[1]{#1}
\newcommand{\typedialvarMo}[1]{#1}
\newcommand{\typedialvarofGu}[1]{#1}
\newcommand{\typedialvarofMo}[1]{#1}
\newcommand{\typeempty}[1]{#1}
\newcommand{\typeEnum}[1]{#1}
\newcommand{\typedialvar}[1]{#1}
\newcommand{\typedialvarof}[1]{#1}
\newcommand{\typefrvar}[1]{#1}
\newcommand{\typefrvarof}[1]{#1}
\newcommand{\typefrgnvar}[1]{#1}
\newcommand{\typefrgnvarof}[1]{#1}
\newcommand{\typeinflvar}[1]{#1}
\newcommand{\typeinflvarof}[1]{#1}
\newcommand{\typePl}[1]{#1}
\newcommand{\typesyn}[1]{#1}
\newcommand{\typeSynT}[1]{#1}
\newcommand{\typevar}[1]{#1}
\newcommand{\typevarof}[1]{#1}
\newcommand{\higha}{\textsuperscript{a}}
\newcommand{\highe}{\textsuperscript{e}}
\newcommand{\higho}{\textsuperscript{o}}
\newcommand{\highE}{\textsuperscript{\textepsilon}}
\newcommand{\highI}{\textsuperscript{ɪ}}
\newcommand{\highU}{\textsuperscript{u}}