...
tsè-òn & → & tsòòn & ‘to dawn’\\\zè-òn & → & zòòn & ‘to be big’\\
\lspbottomrule
\end{tabularx}
\end{table}
...
\textit{Ƙáátaa   Tábayɛɛ   }\textit{ikóteré}\textit{   ɲɛƙᵋ.}
...
\textit{Hyeíá   }\textit{toimɛna}\textit{   mɨtɨda   bɔnán.}
...
\textit{Tábayɔɔ   }\textit{keɗe}\textit{   Fetíékù?}
...
\textit{Ɗ}\textit{ɛmʉsʉ}\textit{   Pakóíce     deti   riékᵃ,}
...
\textit{Ɨ}\textit{táɨa bee     }\textit{kɨxánee}\textit{ kᵉ.}
...
\textit{Pɛlɛmʉɔ   saa     }\textit{tʉmɛdɔɔ}.
...
\textit{Ŋƙɨtá   tɔbɔŋ-}\textit{a}\textit{ na.}
...
\begin{table}
\caption{5 gives the case declension of the deverbalized noun \textit{wetésí- }‘to drink’, which shows vowel assimilation effects on [+ATR] vowels. \tabref{tab:8}.6 does the same for the [-ATR] verb \textit{wɛtsʼɛsɨ- }‘to knap’.}
\label{tab:8}
...
sɛkɔnʉƙɔtᵃ & ‘to fade away’ & ŋƙáƙésuƙotᵃ & ‘to devour’\\\zoonuƙotᵃ & ‘to become big’ & toɓésúƙotᵃ & ‘to plunder’\\
\lspbottomrule
\end{tabularx}
\end{table}
...
naƙwɛs & ‘to suckle’ & naƙwɨtɛs & ‘to give suckle’\\\zízòn & ‘to be fat’ & zízités & ‘to fatten’\\
\lspbottomrule
\end{tabularx}
\end{table}
